        ...
        <div className="min-h-screen bg-gray-100 p-8">
            <div className="mx-auto max-w-7xl">
                ...
                <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    {/* Módulo de CP Productos */}
                    <Link to="/cp-productos" className="block rounded-lg bg-white p-6 shadow-md hover:shadow-lg transition-shadow border-l-4 border-orange-500">
                        <div className="flex items-center justify-between">
                        ...
                        <p className="mt-2 text-gray-600">Gestionar productos CP.</p>
                    </Link>
                </div>
            </div>
        </div>

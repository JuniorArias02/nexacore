...
import { PencilIcon, TrashIcon, PlusIcon, ShieldCheckIcon, UserPlusIcon } from '@heroicons/react/24/outline';
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-violet-600 to-indigo-600 p-8 md:p-12 text-white shadow-2xl mb-8">
                <div className="relative z-10">
                    ...
                    <p className="text-indigo-50 max-w-2xl text-lg">
                        Gestiona los perfiles de permisos y niveles de acceso para garantizar la integridad y seguridad de la información en NexaCore.
                    </p>
            ...
            <div className="bg-white shadow-2xl rounded-3xl overflow-hidden ring-1 ring-gray-900/5 transition-all">
                    ...
                    <table className="min-w-full divide-y divide-gray-100">
                        <thead className="bg-gray-50/50">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-5 text-left text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Nombre del Rol</th>
                                ...
                                <tr>
                                    <td colSpan="3" className="px-6 py-10 text-center">
                                        <div className="flex justify-center flex-col items-center gap-2">
                                            ...
                                            <span className="text-xs font-bold text-slate-400">Cargando privilegios...</span>
                                        </div>
                                    </td>
                                </tr>
                            ) : items.length === 0 ? (
                                <tr>
                                    <td colSpan="3" className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center justify-center">
                                            ...
                                            <p className="text-slate-500 text-sm font-bold tracking-tight">No hay roles configurados actualmente</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
                                    ...
                                    <tr key={item.id} className="hover:bg-indigo-50/30 transition-all duration-200 group">
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-sm font-bold text-slate-900 tracking-tight group-hover:text-indigo-600 transition-colors uppercase tracking-widest">
                                                    {item.nombre}
                                                </span>
                                            </div>
                                        </td>
                ...
                <div className="bg-gray-50/50 px-6 py-4 border-t border-gray-100">
                    <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] text-center">
                        Ecosistema NEXA &copy; {new Date().getFullYear()} - Administración de Seguridad
                    </p>
                </div>
            </div>
        </div>

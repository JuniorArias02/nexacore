        ...
        <div className="mx-auto max-w-4xl px-4 py-8 animate-fade-in font-sans">
            ...
            <div className="bg-white shadow-lg rounded-3xl p-6 mb-8 border border-slate-100 flex items-center">
                ...
                <div>
                    <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">
                        {isEditing ? 'Editar Rol System' : 'Nuevo Perfil de Acceso'}
                    </h1>
                    <p className="text-slate-400 text-sm font-medium">Panel de Seguridad NexaCore</p>
                </div>
            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="group relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="block w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-600 transition-all text-slate-900 placeholder:text-slate-300 font-bold uppercase tracking-widest"
                            ...
                            >
                                <div className="relative z-10 flex items-center justify-center gap-2">
                                    {loading ? (
                                        ...
                                        <>
                                            {isEditing ? 'ACTUALIZAR PRIVILEGIOS' : 'CREAR NUEVO ROL'}
                                        </>
                                    )}
                                </div>
            ...
            <div className="mt-12 text-center">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">
                    NexaCore Security Engine &copy; 2026
                </p>
            </div>
        </div>
    );

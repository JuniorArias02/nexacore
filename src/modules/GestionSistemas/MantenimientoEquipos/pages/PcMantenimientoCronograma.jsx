...
export default function PcMantenimientoCronograma() {
    ...
    const loadData = async () => {
        try {
            setLoading(true);
            const response = await api.get('/gestion-sistemas/pc-mantenimientos/cronograma');
        ...
        <div className="mx-auto max-w-full px-4 py-8 animate-fade-in font-sans">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link
                        to="/gestion-sistemas/pc-mantenimientos/nuevo"
                                    ...
                                    <tr key={item.id} className="hover:bg-slate-50/50 transition-colors group">
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link
                                                    to={`/gestion-sistemas/pc-equipos/hoja-de-vida/${item.id}`}

...
import { PencilIcon, TrashIcon, PlusIcon, Squares2X2Icon, BuildingOfficeIcon } from '@heroicons/react/24/outline';
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-violet-600 to-indigo-600 p-8 md:p-12 text-white shadow-2xl mb-8">
                <div className="relative z-10">
                    ...
                    <p className="text-indigo-50 max-w-2xl text-lg">
                        Administra las divisiones funcionales y departamentos de cada sede para una correcta asignación de recursos y personal.
                    </p>
            ...
            <div className="bg-white shadow-2xl rounded-3xl overflow-hidden ring-1 ring-gray-900/5 transition-all">
                    ...
                    <table className="min-w-full divide-y divide-gray-100">
                        <thead className="bg-gray-50/50">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-5 text-left text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Nombre del Área</th>
                                <th scope="col" className="px-6 py-5 text-left text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Sede ID / Referencia</th>
                                ...
                                <tr>
                                    <td colSpan="4" className="px-6 py-10 text-center">
                                        <div className="flex justify-center flex-col items-center gap-2">
                                            ...
                                            <span className="text-xs font-bold text-slate-400">Cargando unidades...</span>
                                        </div>
                                    </td>
                                </tr>
                            ) : areas.length === 0 ? (
                                    ...
                                    <td colSpan="4" className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center justify-center">
                                            <div className="h-20 w-20 rounded-3xl bg-slate-50 flex items-center justify-center mb-4">
                                                <Squares2X2Icon className="h-10 w-10 text-slate-200" />
                                            </div>
                                            <p className="text-slate-500 text-sm font-bold tracking-tight">No se encontraron áreas registradas</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
                ...
                <div className="bg-gray-50/50 px-6 py-4 border-t border-gray-100">
                    <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em] text-center">
                        Ecosistema NEXA &copy; {new Date().getFullYear()} - Administración de Estructura
                    </p>
                </div>
            </div>
        </div>

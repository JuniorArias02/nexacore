            ...
            <div className="bg-white shadow-lg rounded-3xl p-6 mb-8 border border-slate-100 flex items-center">
                ...
                <div>
                    <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">
                        {isEditing ? 'Editar Área' : 'Nueva Área Funcional'}
                    </h1>
                    <p className="text-slate-400 text-sm font-medium">Estructura de Unidades NexaCore</p>
                </div>
            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="group relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="Ej: Gerencia de Compras"
                                    />
                                </div>
                            </div>
                            ...
                            >
                                <div className="relative z-10 flex items-center justify-center gap-2">
                                    {loading ? (
                                        ...
                                        <>
                                            {isEditing ? 'ACTUALIZAR ÁREA' : 'CREAR UNIDAD'}
                                        </>
                                    )}
                                </div>

...
export default function CpProductoForm() {
    ...
    const loadProducto = async () => {
        try {
            ...
            navigate('/gestion-compras/cp-productos');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="mx-auto max-w-4xl px-4 py-8 animate-fade-in font-sans">
            ...
            <div className="bg-white shadow-lg rounded-3xl p-6 mb-8 border border-slate-100 flex items-center">
                ...
                <div>
                    ...
                    <p className="text-slate-400 text-sm font-medium">Catálogo Maestro de Productos</p>
                </div>
            </div>
            ...
            <div className="mb-8 flex items-center justify-between px-2">
                <Link
                    to="/gestion-compras/cp-productos"
                ...
                <div className="p-8 md:p-12">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="pt-6 flex flex-col sm:flex-row gap-4 border-t border-slate-50">
                            ...
                            <button
                                type="button"
                                onClick={() => navigate('/gestion-compras/cp-productos')}

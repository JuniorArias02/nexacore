            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-violet-600 to-indigo-600 p-8 md:p-12 text-white shadow-2xl mb-8">
                <div className="relative z-10">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row gap-4">
                        <button
                            onClick={() => navigate('/gestion-compras/entrega-activos-fijos/nuevo')}
                                        ...
                                        <tr className="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div className="flex justify-end gap-2">
                                                    <button
                                                        onClick={() => navigate(`/gestion-compras/entrega-activos-fijos/actualizar-firma/${entrega.id}`)}
                                                    ...
                                                    <button
                                                        onClick={() => navigate(`/gestion-compras/entrega-activos-fijos/editar/${entrega.id}`)}
